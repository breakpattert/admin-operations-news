<template>
  <div class="app-container">
    ...
    <el-table  :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="200px" align="center" label="愿望市场封面图">
        <template scope="scope">
          <img :src="scope.row.wish_cover_url" width="100%">
        </template>
      </el-table-column>
...
<!--弹窗之后的的新增页面-->
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" size="large">
      <el-form class="small-space" :model="temp" label-position="left" label-width="100px" style='width: 80%; margin-left:50px;'>
    	...
    	<el-form class="small-space" :model="temp" label-position="left" label-width="100px" style='width: 80%; margin-left:50px;'>
          <el-form-item label="愿望市场封面图">
            <adminImage v-model="temp.wish_cover_url"></adminImage>
          </el-form-item>
      </el-form>
       <el-form class="small-space" :model="temp" label-position="left" label-width="100px" style='width: 80%; margin-left:50px;'>
       		<el-form-item label="活动详情">
          	<el-input v-model="temp.h5_url" placeholder="h5链接地址"></el-input>
        	</el-form-item>
			</el-form>
			<el-form class="small-space" :model="temp" label-position="left" label-width="100px" style='width: 80%; margin-left:50px;'>
...
<script>
    ...
    import {list, update, create, enable, detail, remove} from 'api/homebanner';
      ...
      methods: {
        ...
        getList() {
          ...
          list(this.listQuery).then(res => {
            var d = res.data;
            console.log(d.data.pagination_d_t_o.datas);
        ...
        handleUpdate(row) {
          ...
          detail({id: row.id}).then(res => {
            ...
            if(d.data && d.data.homepage_banner_d_t_o){
              ...
              temp.wish_cover_url = info.wish_cover_url;
              temp.content_url = info.content_url;
              temp.h5_url = info.h5_url;
...
//        var data =  parseTime(this.data);
          var params = {
            ...
            wish_cover_url:temp.wish_cover_url,
            h5_url:temp.h5_url
          }
        ...
        update() {
          ...
          var params = {
            ...
            wish_cover_url:this.temp.wish_cover_url,
            sort: this.temp.sort,
